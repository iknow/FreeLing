 ...
 \item Some external libraries are required to compile FreeLing:
    ...
    \item {\tt libpcre} (version 4.3 or higher)\\ 
     ...
     \item {\tt libdb} (version 4.1.25 or higher) \\
      ...
      \begin{list}{\labelitemiii}{\leftmargin=1em}
      \itemsep 0cm
      \item Ubuntu/Debian: {\tt libdb4.6 libdb4.6-dev libdb4.6++ libdb4.6++-dev}
      \item OpenSuse/Fedora/Mandriva: {\tt libdb-4.6 libdb-4.6-devel libdb\_cxx-4.6}\\
                                      {\tt libdb\_cxx-4.6-devel }
     ...
     \item {\tt libboost} (version 1.31 or higher) \\
      ...
      \begin{list}{\labelitemiii}{\leftmargin=1em}
       \itemsep 0cm
       \item Ubuntu/Debian: {\tt libboost-dev libboost-filesystem libboost-graph}
