...
Just open your favorite software package manager and install them.
 ...
 Ubuntu are provided, though you can do the same using synaptic or a
 similar manager. 

\noindent {\sl Install libpcre headers:}
\begin{verbatim}
 sudo apt-get install libpcre3-dev
\end{verbatim}

\noindent {\sl Install libdb headers}\\
 (version doesn't need to be 4.6. Any 4.x available in your distribution will do):
\begin{verbatim}
 sudo apt-get install libdb4.6++-dev
\end{verbatim}

\noindent {\sl Install libboost headers and binaries}\\
 (in Ubuntu Jaunty, installing this single package, will pull in all the required others):
\begin{verbatim}
...
\noindent {\sl Install libcfg+ library}\\
...
\noindent {\sl Install FreeLing itself:}
\begin{verbatim}
