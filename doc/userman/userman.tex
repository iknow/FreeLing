...
\end{verbatim}
  ...
  Libraries {\tt libcfg+}, {\tt libfries}, and {\tt libomlet} are included in the FreeLing 
...
\item {\sl Install libcfg+ library}\\
 ...
 Get the package\footnote{If you do not have {\tt wget} installed, you simply can use your browser to get the package from  {\tt http://www.platon.sk/projects/libcfg+/}.}:\\
\verb#   wget http://platon.sk/projects/download.php?id=57#

 Unpack it and cd to the package folder:\\
\verb#   tar xzvf libcfg+-0.6.2.tar.gz#\\
\verb#   cd libcfg+-0.6.2#

 Set appropriate flags ({\bf IMPORTANT:} This command is needed only in 64-bit systems. If
  you are using a 32-bit system, just omit it):\\
\verb#   export CPPFLAGS="-fPIC"#
...
\end{verbatim}
 ...
 in FreeLing installation directory ({\tt /usr/local/share/FreeLing/config} 
 if you installed from source, and \verb#/usr/share/FreeLing# if you used a 
 binary {\tt .deb} package).
