...
\end{itemize}
  ...
  build C++ support with the {\tt --enable-cxx} option for {\tt
    ./configure}.
...
\end{verbatim}
  ...
  If you do not have {\tt wget}, you simply can get the package directly from\\
  {\tt http://www.platon.sk/projects/libcfg+/}.
\end{itemize}
