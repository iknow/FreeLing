...
\begin{itemize}
    ...
    \item The Catalan dictionary was obtained from "El Corrector", a Catalan 
     spellchecker project (http://projectes.lafarga.cat/projects/corrector), 
     which was funded  by the Catalan Government, developed by Fundacio 
     Barcelona Media (http://www.barcelonamedia.org/), and released under GPL.
     It contains 640,000 forms for more than 71,000 lemma-PoS combinations.
     See THANKS and COPYING files for further information.
