...
\verb#/usr/local/share/FreeLing# if you installed from source, and to
...
\end{verbatim}
    ...
    if you installed from source, and to \verb#/usr/share/FreeLing# if you 
...
\label{ss-config}
  ...
  alternative location when installing FreeLing. Also, it 
   will be {\tt /usr/share/FreeLing/config} if you
  installed from a binary {\tt .deb} package). 
